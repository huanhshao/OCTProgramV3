...
void OpenGL::RenderScene(){
	...
	if( list == 0 ){
		...
		glBegin(GL_QUADS);
		glTexCoord2f(0.5,0.15);		glVertex3fv(PointA);
		glTexCoord2f(0.5,0.85);		glVertex3fv(PointB);
		glTexCoord2f(0.0,0.85);		glVertex3fv(PointC);
		glTexCoord2f(0.0,0.15);		glVertex3fv(PointD);
		glEnd();
		glEndList();
	}
